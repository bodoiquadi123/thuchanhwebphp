...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Nov 26, 2020 at 01:09 PM
...
('sp1', 'case', 'int', 'Case Jetek Space X - G9326', 'Giao tiếp: 1x USB 3.0 + 2x USB 2.0 Chất liệu: Mặc hông kính cường lực 4mm; Mặt trước nhựa kết hợp bar Led RGB; Thép dày 0.5mm sơn tĩnh điện Fan: Đỉnh 2x 120mm - Trước : 3x 120mm - Sau : 1x 120mm - Cover nguồn 2x120mm (Không kèm fan)', 550, 'imgs/case_3.png'),
('sp10', 'cpu', 'int', 'CPU INTEL Core i7-1700', 'Socket: LGA 1151 , Intel Core thế hệ thứ 7\r\n- Tốc độ xử lý: 3.0 GHz - 3.5 GHz ( 4 nhân, 4 luồng)\r\n- Bộ nhớ đệm: 6MB\r\n- Đồ họa tích hợp: Intel HD Graphics 630', 7600000, 'imgs/cpu_3.jpg'),
('sp11', 'cpu', 'int', 'CPU INTEL Core i7-9700', 'Socket: 1151-v2, Intel Core thế hệ thứ 9\r\nTốc độ: 3.00 GHz up to 4.70 GHz (8nhân, 8 luồng)\r\nBộ nhớ đệm: 12MB\r\nChip đồ họa tích hợp: Intel 630', 4600000, 'imgs/cpu_4.jpg'),
('sp12', 'cpu', 'asrock', 'CPU Intel Core I7-7700K (4.2GHz)', '- Socket: LGA 1151 , Intel Core thế hệ thứ 7\r\n- Tốc độ xử lý: 4.2 GHz ( 4 nhân, 8 luồng)\r\n- Bộ nhớ đệm: 8MB\r\n- Đồ họa tích hợp: Intel HD Graphics 630', 5690000, 'imgs/cpu_5.jpg'),
('sp13', 'cpu', 'int', 'CPU INTEL Core i7-4700', 'Socket: 1151-v2, Intel Core thế hệ thứ 9\r\nTốc độ: 3.00 GHz up to 4.70 GHz (8nhân, 8 luồng)\r\nBộ nhớ đệm: 12MB\r\nChip đồ họa tích hợp: Intel UHD Graphics 630', 8500000, 'imgs/cpu_6.jpg'),
('sp14', 'main', 'asus', 'Mainboard ASUS Rog Strix B460-F GAMINGG', '- Chuẩn mainboard: ATX\r\n- Socket: 1200 , Chipset: B460\r\n- Hỗ trợ RAM: 4 khe DDR4, tối đa 128GB\r\n- Lưu trữ: 1 x M.2 NVMe, Hỗ trợ Intel Optane, 1 x M.2 SATA/NVMe, 6 x SATA 3 6Gb/s\r\n- Cổng xuất hình: 1 x HDMI, 1 x DisplayPort', 3970000, 'imgs/main_2.jpg'),
('sp15', 'main', 'asus', 'Mainboard ASUS STRIX B460-G GAMING', '- Chuẩn mainboard: Micro-ATX\r\n- Socket: 1200 ,\r\n- Hỗ trợ RAM: 4 khe DDR4, tối đa 128GB\r\n- Lưu trữ: 1 x M.2 NVMe, Hỗ trợ Intel Optane, 1 x M.2 SATA/NVMe, 6 x SATA 3 6Gb/s\r\n- Cổng xuất hình: 1 x HDMI, 1 x DisplayPort', 4870000, 'imgs/main_3.jpg'),
('sp16', 'main', 'msi', 'Mainboard MSI A320M-A PRO MAX', '- Chuẩn mainboard: Micro-ATX\r\n- Socket: AM4 , Chipset: A320\r\n- Hỗ trợ RAM: 2 khe DDR4, tối đa 32GB\r\n- Lưu trữ: 4 x SATA 3 6Gb/s, 1 x M.2 SATA/NVMe\r\n- Cổng xuất hình: 1 x HDMI, 1 x DVI-D', 1870000, 'imgs/main_4.jpg'),
('sp17', 'main', 'msi', 'Mainboard MSI B450M-A PRO MAX', '- Chuẩn mainboard: Micro-ATX\r\n- Socket: AM4 , Chipset: B450\r\n- Hỗ trợ RAM: 2 khe DDR4, tối đa 32GB\r\n- Lưu trữ: 4 x SATA 3 6Gb/s, 1 x M.2 SATA/NVMe\r\n- Cổng xuất hình: 1 x HDMI, 1 x DVI-D', 1870000, 'imgs/main_5.jpg'),
('sp18', 'main', 'ggbyte', 'Mainboard GIGABYTE C246-WU4', '- Chuẩn mainboard: ATX\r\n- Socket: 1151-v2 , Chipset: C246\r\n- Hỗ trợ RAM: 4 khe DDR4, tối đa 128GB\r\n- Lưu trữ: 1 x M.2 NVMe, Hỗ trợ Intel Optane, 1 x M.2 SATA/NVMe, 10 x SATA 3 6Gb/s\r\n- Cổng xuất hình: 2 x DisplayPort', 3870000, 'imgs/main_6.jpg'),
('sp19', 'main', 'ggbyte', 'Mainboard GIGABYTE AB350-Gaming 3', '- Chuẩn mainboard: ATX\r\n- Socket: AM4 , Chipset: B350\r\n- Hỗ trợ RAM: DDR4 , tối đa 64GB\r\n- Cổng cắm lưu trữ: 1 x M.2 SATA/NVMe; 6 x SATA 3 6Gb/s\r\n- Cổng xuất hình: 1 x DVI-D; 1 x HDMI', 3670000, 'imgs/main_7.jpg'),
('sp2', 'case', 'asus', 'Case Deepcool Matrexx 50 ADD-RGB 4F', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 319000, 'imgs/case_2.png'),
('sp20', 'main', 'asus', 'Mainboard ASUS ROG STRIX B460-G GAMING', '- Chuẩn mainboard: Micro-ATX\r\n- Socket: 1200 , Chipset: B460\r\n- Hỗ trợ RAM: 4 khe DDR4, tối đa 128GB\r\n- Lưu trữ: 1 x M.2 NVMe, Hỗ trợ Intel Optane, 1 x M.2 SATA/NVMe, 6 x SATA 3 6Gb/s\r\n- Cổng xuất hình: 1 x HDMI, 1 x DisplayPort', 3870000, 'imgs/main_1.jpg'),
('sp3', 'case', 'asus', 'Case Deepcool Matrexx 60 ADD-RGB', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 333000, 'imgs/case_4.png'),
('sp4', 'case', 'antech', 'Case máy tính DEEPCOOL ADD-RGB 3F', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 510000, 'imgs/case_5.png'),
('sp5', 'case', 'antech', 'Case máy tính DEEPCOOL Matrexx 70-RGB 3F - Mid Tower (Đen)', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 319000, 'imgs/case_6.png'),
('sp6', 'case', 'int', 'Thùng máy/ Case 60 ADD-RGB', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 433000, 'imgs/case_7.png'),
('sp7', 'case', 'int', 'Case máy tính DEEPCOOL Matrexx 30(Đen)', '- Hỗ trợ mainboard: Mini-ITX, Micro-ATX, ATX, Extended-ATX\r\n- Khay mở rộng tối đa: 2 x 3.5, 4 x 2.5\r\n- USB: , 1 x USB 3.0, 2 x USB 2.0\r\n- Quạt tặng kèm: 4 x 120 mm RGB', 470000, 'imgs/case_8.png'),
('sp8', 'cpu', 'int', 'CPU INTEL Core i7-9700', 'Socket: 1151-v2, Intel Core thế hệ thứ 9\r\nTốc độ: 3.00 GHz up to 4.70 GHz (8nhân, 8 luồng)\r\nBộ nhớ đệm: 12MB\r\nChip đồ họa tích hợp: Intel UHD Graphics 630', 7600000, 'imgs/cpu_1.jpg'),
('sp9', 'cpu', 'int', 'CPU INTEL Core i7-900', 'Socket: 1151-v2, Intel Core thế hệ thứ 9\r\nTốc độ: 3.00 GHz up to 4.70 GHz (8nhân, 8 luồng)\r\nBộ nhớ đệm: 12MB', 8600000, 'imgs/cpu_2.jpg');
...
ALTER TABLE `khachhang`
  ADD CONSTRAINT `khachhang_ibfk_1` FOREIGN KEY (`madonhang`) REFERENCES `donhang` (`madonhang`);

                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="imgs/case_1.png" alt="">
                                <div class="zoom-icon">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details">
                                <div class="pd-title">
                                    <span>oranges</span>
                                    <h3>Case Jetek Space X - G9326</h3>
                                ...
                                <div class="pd-desc">
                                    <p><i class="fa fa-arrow-right"></i>Giao tiếp: 1x USB 3.0 + 2x USB 2.0 <br>
                                                <i class="fa fa-arrow-right"></i>Chất liệu: Mặc hông kính cường lực 4mm; Mặt trước nhựa kết hợp bar Led RGB; Thép dày 0.5mm sơn tĩnh điện <br>
                                                <i class="fa fa-arrow-right"></i>Fan: Đỉnh 2x 120mm - Trước : 3x 120mm - Sau : 1x 120mm - Cover nguồn 2x120mm (Không kèm fan)</p>
                                    <h4>550.000 VNĐ <span>590.000 VNĐ</span></h4>
                                </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product-item">
                        ...
                        <div class="pi-text">
                            ...
                            <a href="#">
                                <h5>Case Jetek Thompson - G9603B</h5>
                            </a>
